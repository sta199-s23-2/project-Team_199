...
olympics_new |> 
  ...
  labs(x = "Team", y = "Number of Medals", fill = "Medal", 
       title = "Olympic Swimming Medals by Country", subtitle = "countries with 10+ medals, 2000-2016") +
...
olympics3 <- olympics_new |> 
  ...
  filter(Sport == "Swimming",
         Year > 1991,
         Team == c("United States", "Australia", "Japan", "Netherlands", "France", "China", "Germany", "Great Britain", "Russia", "Canada", "Italy", "Hungary", "South Africa", "Sweden")) |> 
